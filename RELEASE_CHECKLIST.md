...
- [ ] **Privacy policy** — Confirm `PRIVACY_POLICY.md` reflects current build behaviour. Link it from the Steam store page (Steamworks partner site → Store Page → Basic Info → Privacy Policy URL).
